...
class Matching(object):
    def __init__(self, left_img="./left_nav_pair/10268.jpg",
                 right_img="./right_nav_pair/10268.jpg", max_disparity=150,
                 max_vertical_shift=2, min_vertical_shift=2, block_size=7):

        self.left_img = Image.open(left_img, "gray")
        self.right_img = Image.open(right_img, "gray")
    ...
    def _padding(self):
        ...
        self.right_img_padded = transforms.()
